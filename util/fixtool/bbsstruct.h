...
struct userec
{
  ...
  char feeling[4];		  /* 心情指數     4 bytes */
  int pagermode; 		  /* 呼叫器門號   4 bytes */
  char pagernum[6];		  /* 呼叫器號碼   6 bytes */
  char pad[125];                  /* 空著填滿至512用      */
};
...
#define	FILE_CERTIFIED	0x4	/* 掛號信 :p (LinuxBoy) */
...
#define BRD_FAMILY      02000         /* 家族看板 */
#define BRD_NOFORWARD   04000         /* 禁止轉錄 */
...
/* ----------------------------------------------------- */
/* kenshieh.20020205: Yahoo Kimo News 所用到的結構       */
/* ----------------------------------------------------- */

#define NEWSHOME  "/home/bbs/news/"
#define NEWS_POLITY             0x0001  /* 政治 */
#define NEWS_REALTIME           0x0002  /* 即時 */
#define NEWS_SOCIETY            0x0004  /* 社會 */
#define NEWS_INTERNATIONAL      0x0008  /* 國際 */
#define NEWS_TWOSHORE           0x0010  /* 兩岸 */
#define NEWS_FINANCE            0x0020  /* 金融 */
#define NEWS_ENTERTAIN          0x0040  /* 影視 */
#define NEWS_SPORTS             0x0080  /* 運動 */
#define NEWS_LEISURE            0x0100  /* 生活 */
#define NEWS_HEALTH             0x0200  /* 健康 */
#define NEWS_TECHNOLOGY         0x0400  /* 科技 */
                                                                                  
#define NEWS_UDN        (NEWS_POLITY | NEWS_SOCIETY | NEWS_INTERNATIONAL | NEWS_FINANCE | NEWS_ENTERTAIN | NEWS_SPORTS | NEWS_LEISURE | NEWS_TECHNOLOGY | NEWS_TWOSHORE | NEWS_HEALTH)

#define NEWS_CTNEWS     (NEWS_POLITY | NEWS_REALTIME | NEWS_SOCIETY | NEWS_INTERNATIONAL | NEWS_FINANCE | NEWS_ENTERTAIN | NEWS_SPORTS | NEWS_LEISURE | NEWS_TECHNOLOGY | NEWS_TWOSHORE | NEWS_HEALTH)

#define NEWS_TWDAILY    NEWS_POLITY
                                                                                  
#define NEWS_REUTERS    (NEWS_REALTIME | NEWS_FINANCE | NEWS_SPORTS | NEWS_TECHNOLOGY)
                                                                                  
#define NEWS_CNA        (NEWS_POLITY | NEWS_REALTIME | NEWS_SOCIETY | NEWS_INTERNATIONAL | NEWS_FINANCE | NEWS_ENTERTAIN | NEWS_SPORTS | NEWS_LEISURE | NEWS_TWOSHORE | NEWS_HEALTH)
                                                                                  
#define NEWS_FTV        (NEWS_POLITY | NEWS_REALTIME | NEWS_SOCIETY | NEWS_INTERNATIONAL | NEWS_FINANCE | NEWS_ENTERTAIN | NEWS_SPORTS | NEWS_LEISURE)
                                                                                  
#define NEWS_PNN        (NEWS_POLITY | NEWS_SOCIETY | NEWS_INTERNATIONAL | NEWS_FINANCE | NEWS_ENTERTAIN | NEWS_SPORTS | NEWS_LEISURE)
                                                                                  
#define NEWS_CNYES      (NEWS_REALTIME | NEWS_FINANCE | NEWS_TECHNOLOGY)
                                                                                  
#define NEWS_ZDNET      NEWS_TECHNOLOGY
                                                                                  
#define NEWS_GREAT      NEWS_ENTERTAIN
                                                                                  
typedef struct takeALL
{
  char title[256];      /* Head */
  char file[64];        /* File */
  char url[256];        /* URL */
