  ...
  char *textline;
{
  ...
  else
  {
...
#if 0 
    //不要讓別人看不到:p
    //by Paulliu  For RFC 2047
    //source page: http://cnal.csie.nctu.edu.tw/~paulliu/pl03.txt
    fprintf(NNTPwfp, "Subject: ");
    output_rfc2047_qp(NNTPwfp, sover->subject,"Big5");
    fprintf(NNTPwfp, "\r\n");
#endif 
    fprintf(NNTPwfp, "Subject: %s\r\n", sover->subject);
    fprintf(NNTPwfp, "Date: %s\r\n", sover->date);
    ...
    //hialan: FOR RFC 2045 by paulliu
