...
#define WEBPORT 80
#define PARA    "Connection: Keep-Alive\nUser-Agent: Mozilla/4.5b1 [en] (X11; I; FreeBSD 5.4-STABLE i386)\nContent-type: application/x-www-form-urlencoded\nAccept: image/gif, image/x-xbitmap, image/jpeg, image/pjpeg, image/png, \
...
bbcall_adduser (int max)
{
  ...
  sethomefile (fpath, cuser.userid, "bbcalllist");
  ...
  do
      ...
      if (screen_refresh)
    {
      ...
      switch (screen_mode)
        {
        case 0:
          prints ("[47;30m ½s¸¹  ¦W¦r©Î¥N¸¹  ¤À  Ãþ ¥Í ¤é ¹q¸Ü               ¶Ç©I¸¹½X     ¶Ç©I±K½X      [0m");
          break;
        case 1:
          prints ("[47;30m ½s¸¹  ¦W¦r©Î¥N¸¹  ¤À  Ãþ ¹q¤l«H½c¡]´N¬O©Ò¿×ªºE-Mail°Õ¡I¼öÁä M ¡^             [0m");
          break;
        case 2:
          prints ("[47;30m ½s¸¹  ¦W¦r©Î¥N¸¹  ³sµ¸¦a§}¡]¾Ç®Õ©Î®a¸Ìªº¦í§}¡A¦³ªÅ°O±o¥h«ô³X«ô³X³á¡I¡^       [0m");
          break;
        case 3:
          prints ("[47;30m ½s¸¹  ¦W¦r©Î¥N¸¹  »²§U»¡©ú¡]¤Í½Ë´y­z¡^                                       [0m");
          break;
        }
    }
      if (data_refresh)
      ...
      if (data_count == 0)
    {
      ...
      move (b_lines, 0);
      prints ("[1;46;37m ³q°T¿ý¦W³æ [0;30;47m ¦@³]©w[31m%3d[30m/%3d¸ê®Æ  [31m[M/m][30m¯¸¥~/¯¸¤º±H«H [31m[Tab][30m¤Á´«µe­±              [0m", data_count, data_max);
    }
      else
    {
